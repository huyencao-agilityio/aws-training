...
-- DropForeignKey
ALTER TABLE "Order" DROP CONSTRAINT "Order_owner_id_fkey";
...
-- AddForeignKey
ALTER TABLE "carts" ADD CONSTRAINT "carts_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
